    ...
    <tbody>
        @foreach ($registros as $registro)
            <tr>
                ...
                <td>
                    <a href="pdfregistroacciones?id={{ $registro->id }}" target="_blank"><button type="button"
                ...
                <td>
                    ...
                    @else
                        <a onclick="showModalArchivos({{ $registro->id }})" data-toggle="modal"
                            data-target="#detalleArchivos"><img style="width: 30px; heigth: 30px;" src="{{ URL::to('bicicletas/' . $registro->foto) }}"></a>
                    @endif
                </td>
